      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-card border border-border shadow-xs">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-1.5 bg-background border border-input rounded-xl text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-emerald-500"
          />
        </div>
      </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {item.pass?.holderEmail && (
                    <span className="text-xs text-muted-foreground font-medium">({item.pass.holderEmail})</span>
                  )}
                </div>
